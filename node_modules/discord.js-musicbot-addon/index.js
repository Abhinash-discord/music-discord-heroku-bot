...
try {
    ...
    musicbot.playFunction = (msg, suffix, args, ignore) => {
      ...
      if (searchstring.startsWith('http') && searchstring.includes("list=")) {
        ...
        if (!ignore) msg.channel.send(musicbot.note("search", `\`Searching: ${searchstring}\` **on** <:Youtube:702366362743341076> `));
    ...
    musicbot.skipFunction = (msg, suffix, args) => {
      ...
      dispatcher.end();
      msg.channel.send(musicbot.note("note", "Skipped :thumbsup:"));
    };
    ...
    musicbot.pauseFunction = (msg, suffix, args) => {
      ...
      msg.channel.send(musicbot.note('note', 'Playback :pause_button:'));
    };
    ...
    musicbot.resumeFunction = (msg, suffix, args) => {
      ...
      msg.channel.send(musicbot.note('note', 'Playback :arrow_forward:'));
    };
    ...
    musicbot.leaveFunction = (msg, suffix) => {
      if (musicbot.isAdmin(msg.member) || musicbot.anyoneCanLeave === true) {
        ...
        musicbot.emptyQueue(msg.guild.id).then(() => {
          ...
          msg.channel.send(musicbot.note('note', '**Successfully disconnected** :mailbox: '));
        }).catch((res) => {

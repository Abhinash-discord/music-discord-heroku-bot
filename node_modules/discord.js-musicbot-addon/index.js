...
try {
    ...
    class Music {
      constructor(client, options) {
        ...
        this.mhelp = {
          enabled: (options.mhelp == undefined ? true : (options.mhelp && typeof options.mhelp.enabled !== 'undefined' ? options.mhelp && options.mhelp.enabled : true)),
          run: "helpFunction",
          alt: (options && options.mhelp && options.mhelp.alt) || [],
          help: (options && options.mhelp && options.mhelp.help) || "Help for commands.",
          name: (options && options.mhelp && options.mhelp.name) || "mhelp",
          usage: (options && options.mhelp && options.mhelp.usage) || null,
          exclude: Boolean((options && options.mhelp && options.mhelp.exclude)),
          masked: "mhelp"
        };
        ...
        this.embedColor = (options && options.embedColor) || '00ffff';
